...
<rapid:override name="content">
	<form id="queryForm" name="queryForm" action="<c:url value="/pages/Users/list.do"/>" method="get" style="display: inline;">
	<div class="queryPanel">
		...
		<div class="handleControl">
			<input type="submit" class="stdButton" style="width:80px" value="查询" onclick="getReferenceForm(this).action='${ctx}/pages/Users/list.do'"/>
			<input type="submit" class="stdButton" style="width:80px" value="新增" onclick="getReferenceForm(this).action='${ctx}/pages/Users/create.do'"/>
			<input type="button" class="stdButton" style="width:80px" value="删除" onclick="batchDelete('${ctx}/pages/Users/delete.do','items',document.forms.queryForm)"/>
		<div>
	</div>
